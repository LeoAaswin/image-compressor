...
export function Header() {
  ...
  const toolCategories: Record<string, ToolCategory> = useMemo(() => ({
    ...
    advanced2: {
      name: 'Create',
      icon: <Wrench className="w-4 h-4" />,
      description: 'Creation tools',
      tools: [
        {
          name: 'GIF Maker',
          href: '/gif',
          description: 'Create & extract GIFs',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5">
              <rect x="2" y="2" width="20" height="20" rx="2" />
              <path d="M7 12h4M9 10v4" />
              <path d="M13 10v4M13 12h3" />
              <path d="M17 10v4" />
            </svg>
          ),
        },
        ...
        },
        {
          name: 'PDF ↔ Image',
          href: '/pdf',
          description: 'Convert PDF & images',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5">
    ...
    utilities: {
      ...
      tools: [
        ...
        },
        {
          name: 'QR Reader',
          href: '/qr-reader',
          description: 'Decode QR codes',
          icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5">
              <rect x="3" y="3" width="5" height="5" />
              <rect x="16" y="3" width="5" height="5" />
              <rect x="3" y="16" width="5" height="5" />
              <path d="M21 16h-3v3M21 21v-1M16 21h1" />
